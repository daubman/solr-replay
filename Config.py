...
DELAY_MULT = 0.8 #set to 0 to disable delay in producer
...
#REPLACE_TERM = None
#REPLACE_WITH = None
MANAGER_STARTS_CONSUMERS = 4 #Typically the same or one greater than the number of producers, 0 if running distributed Consumers
